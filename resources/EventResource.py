...
class EventResource(Resource):
    def get(self, investor_id=None, event_id=None):
        if investor_id is not None and event_id is None:
            ...
            transaction = get_event_count(investor_id,query_sort, query_from, query_count)
        else:
            transaction = get_event_by_Inv(event_id)
    ...
    def post(self,investor_id):
        event = get_event_by_Inv(investor_id)
